...
class SearchResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void launchShazamApp() async {
      const shazamUrl = 'shazam://'; // Check the correct URL scheme for Shazam
      if (await canLaunch(shazamUrl)) {
        await launch(shazamUrl);
      } else {
        // Shazam not installed, handle this case as needed
        print('Shazam is not installed.');
      }
    }
