...
class Player extends StatelessWidget {
  ...
  children: [
    InkWell(
      onLongPress: () {
        // Your existing code for showing the SongInfoBottomSheet
        showModalBottomSheet(
      ...
      child: Column(
        children: [
          // Transparent "Tap to show lyrics" button
          TextButton(
            onPressed: () {
              playerController.showLyrics();
            },
            child: Text("Tap to show lyrics", style: TextStyle(color: Colors.white)),
          ),
          ImageWidget(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Obx(
                      () => playerController.isLyricsLoading.isFalse
                        ? Text(
                            playerController.lyrics.value == "NA"
